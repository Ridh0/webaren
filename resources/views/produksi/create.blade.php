...
<h1 class="mt-4">Dashboard</h1>
  ...
  <input type="hidden" name="moreFields[0][id_user]" value="{{ Auth::user()->id }} ">
    ...
    <div class="card-header">
      ...
      <td><button type="button" name="add" id="add-btn" class="float-right text-white btn btn-danger">Add More</button></td>  
      <td><button type="submit" id="add-btn" class="btn text-white btn-success">Selesai</button></td>  
