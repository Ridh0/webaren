                        ...
                        <div class="col-sm-12">
                            ...
                            <div id="Mylist" class="list-group  pb-3">
                                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start ">
                                    ...
                                    <button data-id="{{$row->id}}" data-ar="{{$row->ar}}" data-nwo="{{$row->nwo}}" data-aj="{{$row->aj}}" data-toi="{{$row->toi}}" data-gt="{{$row->gt}}" data-gp="{{$row->gp}}" data-k="{{$row->k}}" data-tjawa="{{$row->tjawa}}" data-rbs="{{$row->rbs}}" class="btn btn-warning" id="submit{{$row->id}}" type="button" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-edit"></i></button>
                                </a>
                                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <ul class="list-group">
