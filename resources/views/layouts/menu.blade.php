@if(auth()->user()->username == 'produksi')
<div class="sb-sidenav-menu-heading">Admin Produksi</div>
<a class="nav-link single-menu {{ route_is('produksi') ? 'active' : '' }}" href="{{route('produksi')}}">
    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
    Data Produksi
</a>
<a class="nav-link mt-2 single-menu {{ route_is('produksi.hasil') ? 'active' : '' }}" href="{{route('produksi.hasil')}}">
    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
    Hasil Produksi
</a>
