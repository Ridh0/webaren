        ...
        <div class="card-body">
            <div class="collapse" id="masuk">
                <div class="card card-body mb-3">
                    ...
                    <form action="{{route('inventori.export.pdf.harian')}}" method="GET">
                        @else
                        <form action="{{route('inventori.export.pdf.bulanan')}}" method="GET">
                            @endif
                            @csrf
                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <input type="hidden" name="jangkawaktu" value="{{request()->segment(3)}}" id="">
                                <input type="hidden" name="keterangan" value="Masuk" id="">
            ...
            <table id="datatablesSimple" class="table" width="100%">
                <thead>
                    <tr class="table bg-dark text-white">
                        ...
                        <th scope="col">Total Hasil Produksi</th>
                        <th scope="col">Total Bahan Baku</th>
                    ...
                    <form action="{{route('inventori.export.pdf.harian')}}" method="GET">
                        ...
                        <form action="{{route('inventori.export.pdf.bulanan')}}" method="GET">
                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <input type="hidden" name="jangkawaktu" value="{{request()->segment(3)}}" id="">
                                <input type="hidden" name="keterangan" value="Keluar" id="">
                                <div class="col-auto my-1 pt-3 mt-2">
